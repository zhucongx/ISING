#ifndef ISING_ISING_INCLUDE_VECTORMATRIX_HPP_
#define ISING_ISING_INCLUDE_VECTORMATRIX_HPP_
...
inline Vector_t SpinAbs(const Vector_t &vector) {
  return {
...
inline Vector_t SpinFloor(const Vector_t &vector) {
  return {
...
inline Vector_t SpinProduct(const Vector_t &first, const Vector_t &second) {
  return {
...
inline Vector_t SpinDivide(const Vector_t &dividend,
...
#endif //ISING_ISING_INCLUDE_VECTORMATRIX_HPP_
